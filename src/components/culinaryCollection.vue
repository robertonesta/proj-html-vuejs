...
<template>
    <div class="culinaryCollection_section container my-5">
        <div class="culinaryCollection_title text-center py-3">
            <h5 class="text-uppercase py-2">culinary collection</h5>
